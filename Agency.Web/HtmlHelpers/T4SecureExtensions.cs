...
namespace Agency.Web.HtmlHelpers
{
    public static class T4SecureExtensions
    {
        ...
        public static MvcHtmlString SideBarSecureActionLink(this HtmlHelper htmlHelper, string linkText, string url, string cssClass, string spanCssClass,string id, params string[] permission)
        {
            //var hasPermission = permission.Any(HttpContext.Current.User.IsInRole);
            //if (!hasPermission) return MvcHtmlString.Empty;
