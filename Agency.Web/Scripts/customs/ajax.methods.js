...
/*############### OnCompletes ##############*/
function editModelaOnComplete(xhr, status, containerId, modal, formId, btn) {
...
function editModelaOnCompleteForCancel(xhr, status, containerId, modal, formId, btn) {
...
function editModelaOnCompleteForCancel2(xhr, status, containerId, modal, formId, btn) {
...
function createOnCompletewithReload(xhr, status, containerId, modal, formId, btn) {
    var data = $.parseJSON(xhr.responseText);
    var $boxes = $(data.View);
    if (xhr.status == 403) {
        window.location = '/Account/Login';
