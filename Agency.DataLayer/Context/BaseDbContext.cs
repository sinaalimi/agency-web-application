...
using Agency.DomainClasses.Configurations.User;
using Microsoft.AspNet.Identity.EntityFramework;
using Agency.DomainClasses.Entities.common;
using Agency.DomainClasses.Entities.User;
using Agency.Utilities;

namespace Agency.DataLayer.Context
{
    public class BaseDbContext : IdentityDbContext<User, Role, Guid, UserLogin, UserRole, UserClaim>
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            LoadEntities(typeof(User).Assembly, modelBuilder, "Agency.DomainClasses.Entities");
        }
