...
namespace Agency.ServiceLayer.EFService.Users
{
    public class RoleManager : RoleManager<Role, Guid>, IApplicationRoleManager
    {
        ...
        #region Constructor
        public RoleManager(IMapper mappingEngine, IPermissionService permissionService, IUnitOfWork unitOfWork, IRoleStore<Role, Guid> roleStore, MapperConfiguration configuration)
            : base(roleStore)
        {
        ...
        {
            return await _roles.ProjectTo<RoleViewModel>(_configuration).ToListAsync();
        }
        #endregion
        ...
        public async Task<RoleListViewModel> GetPageList(RoleSearchRequest request)
        {
            ...
            var selectedTitles = roles.ProjectTo<RoleViewModel>(_configuration);
        ...
        {
            var roles =
                await _roles.AsNoTracking().ProjectTo<SelectListItem>(_configuration).ToListAsync();
            return roles;
        }
        #endregion
